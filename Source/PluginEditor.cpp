    ...
    : AudioProcessorEditor (&p), processor (p)
{
    ...
    for(const auto& note : guitarnotes)
    {
        ...
        note->setCaretVisible (false);
        note->setPopupMenuEnabled (false);
        note->setColour (TextEditor::outlineColourId, Colour (0x00522d2d));
        note->setColour (TextEditor::shadowColourId, Colour (0x00c12323));
